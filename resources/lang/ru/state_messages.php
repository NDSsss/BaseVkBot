...
Стать волонтером проекта — https://covidarnost.ru/volonteer/',
    ...
    StatesNamesEnum::$HELP_CHAT_FOUND=>'Спасибо! Я определил ваш адрес — :address. Ваши соседи уже создали чат. Присоединяйтесь — :url. Если адрес определился — пришлите его текстом',
