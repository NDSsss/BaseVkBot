...
class TriggerWordsSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $values[] = ['id'=>9,'state_id'=>3,'type'=>'text','word'=>'Чат моего дома'];
        $values[] = ['id'=>10,'state_id'=>4,'type'=>'text','word'=>'Памятка'];
        $values[] = ['id'=>11,'state_id'=>5,'type'=>'location','word'=>'geo'];
        $values[] = ['id'=>12,'state_id'=>7,'type'=>'text','word'=>'Создать чат'];
